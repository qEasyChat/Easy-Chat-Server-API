...
private:
	...
	void send_data_to_all(std::string username, std::vector<unsigned char> data);
	void send_data_to_one(std::string username, std::string destination_username, std::vector<unsigned char> data);
